...
#define PIN_HOPPER_P1   4          /* e.g. 8  */
#define PIN_HOPPER_P5   5          /* e.g. 7  */
#define PIN_HOPPER_P10         /* e.g. 1  */
...
#define SHORT_STEP_US             500    // microseconds high/low
